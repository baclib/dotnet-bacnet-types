    ...
    IAsduPrimitiveCodec<T.WriteStatus>
{
    ...
    public static T.WriteStatus Decode(ref AsduReader reader)
        => AsduPrimitive.Decode<WriteStatusCodec, T.WriteStatus>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.WriteStatus Decode(ref AsduReader reader, byte tagNumber)
        => AsduPrimitive.Decode<WriteStatusCodec, T.WriteStatus>(ref reader, tagNumber);
    ...
    public static void Encode(ref AsduWriter writer, in T.WriteStatus value)
        => AsduPrimitive.Encode<WriteStatusCodec, T.WriteStatus>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref AsduWriter writer, byte tagNumber, in T.WriteStatus value)
        => AsduPrimitive.Encode<WriteStatusCodec, T.WriteStatus>(ref writer, tagNumber, value);
    ...
    public static int GetEncodedLength(in T.WriteStatus value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetEncodedLength(in T.WriteStatus value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
