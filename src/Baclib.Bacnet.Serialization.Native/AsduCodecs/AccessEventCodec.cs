    ...
    IAsduPrimitiveCodec<T.AccessEvent>
{
    ...
    public static T.AccessEvent Decode(ref AsduReader reader)
        => AsduPrimitive.Decode<AccessEventCodec, T.AccessEvent>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.AccessEvent Decode(ref AsduReader reader, byte tagNumber)
        => AsduPrimitive.Decode<AccessEventCodec, T.AccessEvent>(ref reader, tagNumber);
    ...
    public static void Encode(ref AsduWriter writer, in T.AccessEvent value)
        => AsduPrimitive.Encode<AccessEventCodec, T.AccessEvent>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref AsduWriter writer, byte tagNumber, in T.AccessEvent value)
        => AsduPrimitive.Encode<AccessEventCodec, T.AccessEvent>(ref writer, tagNumber, value);
    ...
    public static int GetEncodedLength(in T.AccessEvent value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetEncodedLength(in T.AccessEvent value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
