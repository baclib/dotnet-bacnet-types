    ...
    IAsduPrimitiveCodec<ObjectIdentifier>
{
    ...
    /// </summary>
    /// <param name="reader">The reader positioned at an object identifier primitive tag.</param>
    /// <returns>The decoded value.</returns>
    public static ObjectIdentifier Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<ObjectIdentifierCodec, ObjectIdentifier>(ref reader);
    ...
    /// <returns>The decoded value.</returns>
    public static ObjectIdentifier Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<ObjectIdentifierCodec, ObjectIdentifier>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in ObjectIdentifier value)
        => Asdu.EncodePrimitive<ObjectIdentifierCodec, ObjectIdentifier>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in ObjectIdentifier value)
        => Asdu.EncodePrimitive<ObjectIdentifierCodec, ObjectIdentifier>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in ObjectIdentifier value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in ObjectIdentifier value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
