...
/// <summary>
/// Provides BACnet ASDU primitive decoding and encoding for <see cref="T.GetEnrollmentSummaryRequest.TEventStateFilter"/> values.
/// </summary>
public sealed class GetEnrollmentSummaryRequestTEventStateFilterCodec :
    IAsduElementCodec<T.GetEnrollmentSummaryRequest.TEventStateFilter>,
    IAsduPrimitiveCodec<T.GetEnrollmentSummaryRequest.TEventStateFilter>
{
    /// <summary>
    /// Decodes an <see cref="T.GetEnrollmentSummaryRequest.TEventStateFilter"/> value from the current reader position using the application tag.
    /// </summary>
    ...
    public static T.GetEnrollmentSummaryRequest.TEventStateFilter DecodeValue(ReadOnlySpan<byte> source)
    {
        return source.Length switch
        {
            AsduLength.Enumerated8 => (T.GetEnrollmentSummaryRequest.TEventStateFilter)AsduBinaryPrimitives.ReadUnsigned8(source),
            _ => throw new ArgumentOutOfRangeException(nameof(source))
        };
    }

    /// <summary>
    /// Encodes an <see cref="T.GetEnrollmentSummaryRequest.TEventStateFilter"/> value using the application tag.
    /// </summary>
    ...
    public static void EncodeValue(Span<byte> destination, in T.GetEnrollmentSummaryRequest.TEventStateFilter value)
    {
    ...
    /// <summary>
    /// Gets the encoded payload length for an <see cref="T.GetEnrollmentSummaryRequest.TEventStateFilter"/> value.
    /// </summary>
    /// <param name="value">The value whose payload length is requested.</param>
    /// <returns>The encoded payload length in bytes.</returns>
    public static int GetEncodedValueLength(in T.GetEnrollmentSummaryRequest.TEventStateFilter value)
