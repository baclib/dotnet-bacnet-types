    ...
    IAsduPrimitiveCodec<T.BinaryLightingPv>
{
    ...
    public static T.BinaryLightingPv Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<BinaryLightingPvCodec, T.BinaryLightingPv>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.BinaryLightingPv Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<BinaryLightingPvCodec, T.BinaryLightingPv>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.BinaryLightingPv value)
        => Asdu.EncodePrimitive<BinaryLightingPvCodec, T.BinaryLightingPv>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.BinaryLightingPv value)
        => Asdu.EncodePrimitive<BinaryLightingPvCodec, T.BinaryLightingPv>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.BinaryLightingPv value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.BinaryLightingPv value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
