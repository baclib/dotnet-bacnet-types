    ...
    IAsduPrimitiveCodec<Null>
{
    ...
    public static Null Decode(ref NativeReader reader)
    {
    ...
    /// <returns>The decoded null value.</returns>
    /// <exception cref="FormatException">Thrown when the encoded value is not 0.</exception>
    public static Null Decode(ref NativeReader reader, byte tagNumber)
    {
    ...
    public static void Encode(ref NativeWriter writer, in Null value)
        => writer.WriteByte(0);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in Null value)
        => Asdu.EncodePrimitive<NullCodec, Null>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in Null value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in Null value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
