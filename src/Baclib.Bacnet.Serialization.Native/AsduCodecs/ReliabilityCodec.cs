    ...
    IAsduPrimitiveCodec<T.Reliability>
{
    ...
    public static T.Reliability Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<ReliabilityCodec, T.Reliability>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.Reliability Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<ReliabilityCodec, T.Reliability>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.Reliability value)
        => Asdu.EncodePrimitive<ReliabilityCodec, T.Reliability>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.Reliability value)
        => Asdu.EncodePrimitive<ReliabilityCodec, T.Reliability>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.Reliability value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.Reliability value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
