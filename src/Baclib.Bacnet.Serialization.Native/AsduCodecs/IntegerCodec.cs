...
/// <summary>
/// Provides BACnet ASDU primitive decoding and encoding for <see cref="Integer"/> values.
/// </summary>
    ...
    IAsduPrimitiveCodec<int>
{
    ...
    /// <summary>
    /// Gets the encoded payload length for a <see cref="Integer"/> value.
    /// </summary>
    /// <param name="value">The value whose payload length is requested.</param>
    /// <returns>The encoded payload length in bytes.</returns>
    public static int GetEncodedValueLength(in int value)
        => AsduLength.FromInteger(value);
