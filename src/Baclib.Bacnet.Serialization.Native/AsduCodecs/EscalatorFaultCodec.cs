    ...
    IAsduPrimitiveCodec<T.EscalatorFault>
{
    ...
    public static T.EscalatorFault Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<EscalatorFaultCodec, T.EscalatorFault>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.EscalatorFault Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<EscalatorFaultCodec, T.EscalatorFault>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.EscalatorFault value)
        => Asdu.EncodePrimitive<EscalatorFaultCodec, T.EscalatorFault>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.EscalatorFault value)
        => Asdu.EncodePrimitive<EscalatorFaultCodec, T.EscalatorFault>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.EscalatorFault value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.EscalatorFault value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
