    ...
    IAsduPrimitiveCodec<T.ObjectTypesSupported>
{
    ...
    public static T.ObjectTypesSupported Decode(ref AsduReader reader)
        => AsduPrimitive.Decode<ObjectTypesSupportedCodec, T.ObjectTypesSupported>(ref reader);
    ...
    /// <returns>The decoded value.</returns>
    public static T.ObjectTypesSupported Decode(ref AsduReader reader, byte tagNumber)
        => AsduPrimitive.Decode<ObjectTypesSupportedCodec, T.ObjectTypesSupported>(ref reader, tagNumber);
    ...
    public static void Encode(ref AsduWriter writer, in T.ObjectTypesSupported value)
        => AsduPrimitive.Encode<ObjectTypesSupportedCodec, T.ObjectTypesSupported>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref AsduWriter writer, byte tagNumber, in T.ObjectTypesSupported value)
        => AsduPrimitive.Encode<ObjectTypesSupportedCodec, T.ObjectTypesSupported>(ref writer, tagNumber, value);
    ...
    public static int GetEncodedLength(in T.ObjectTypesSupported value)
        => AsduPrimitive.GetEncodedLength<ObjectTypesSupportedCodec, T.ObjectTypesSupported>(value);
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetEncodedLength(in T.ObjectTypesSupported value, byte tagNumber)
        => AsduPrimitive.GetEncodedLength<ObjectTypesSupportedCodec, T.ObjectTypesSupported>(tagNumber, value);
