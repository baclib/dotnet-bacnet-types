    ...
    IAsduPrimitiveCodec<T.NetworkType>
{
    ...
    public static T.NetworkType Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<NetworkTypeCodec, T.NetworkType>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.NetworkType Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<NetworkTypeCodec, T.NetworkType>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.NetworkType value)
        => Asdu.EncodePrimitive<NetworkTypeCodec, T.NetworkType>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.NetworkType value)
        => Asdu.EncodePrimitive<NetworkTypeCodec, T.NetworkType>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.NetworkType value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.NetworkType value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
