    ...
    IAsduPrimitiveCodec<T.EventTransitionBits>
{
    ...
    public static T.EventTransitionBits Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<EventTransitionBitsCodec, T.EventTransitionBits>(ref reader);
    ...
    /// <returns>The decoded value.</returns>
    public static T.EventTransitionBits Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<EventTransitionBitsCodec, T.EventTransitionBits>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.EventTransitionBits value)
        => Asdu.EncodePrimitive<EventTransitionBitsCodec, T.EventTransitionBits>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.EventTransitionBits value)
        => Asdu.EncodePrimitive<EventTransitionBitsCodec, T.EventTransitionBits>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.EventTransitionBits value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.EventTransitionBits value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
