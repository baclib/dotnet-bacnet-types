    ...
    IAsduPrimitiveCodec<short>
{
    ...
    public static short Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<Integer16Codec, short>(ref reader);
    ...
    /// <returns>The decoded value.</returns>
    public static short Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<Integer16Codec, short>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in short value)
        => Asdu.EncodePrimitive<Integer16Codec, short>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in short value)
        => Asdu.EncodePrimitive<Integer16Codec, short>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in short value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in short value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
