    ...
    IAsduPrimitiveCodec<T.LoggingType>
{
    ...
    public static T.LoggingType Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<LoggingTypeCodec, T.LoggingType>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.LoggingType Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<LoggingTypeCodec, T.LoggingType>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.LoggingType value)
        => Asdu.EncodePrimitive<LoggingTypeCodec, T.LoggingType>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.LoggingType value)
        => Asdu.EncodePrimitive<LoggingTypeCodec, T.LoggingType>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.LoggingType value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.LoggingType value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
