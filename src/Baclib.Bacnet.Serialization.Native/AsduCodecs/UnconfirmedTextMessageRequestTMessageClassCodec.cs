    ...
    IAsduConstructedCodec<global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass>
{
    ...
    public static global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass Decode(ref NativeReader reader)
    {
        ...
        switch (tagNumber)
        {
            case 0:
                ...
                return global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass.FromNumeric(_numeric);
            case 1:
                ...
                return global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass.FromCharacter(_character);
        }
        throw new FormatException(nameof(reader));
    }

    public static global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass Decode(ref NativeReader reader, byte tagNumber)
    {
    ...
    public static void Encode(ref NativeWriter writer, in global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass value)
    {
        switch (value.Choice)
        {
    ...
    public static void Encode(ref NativeWriter writer, byte tagNumber, in global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass value)
    {
    ...
    public static int GetLength(in global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass value)
    {
        switch (value.Choice)
        {
            case global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass.Option.Numeric:
    ...
    public static int GetLength(in global::Baclib.Bacnet.Types.Application.UnconfirmedTextMessageRequest.TMessageClass value, byte tagNumber)
    {
