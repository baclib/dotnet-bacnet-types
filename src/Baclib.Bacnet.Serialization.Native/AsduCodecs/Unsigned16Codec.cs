...
/// <summary>
/// Provides BACnet ASDU primitive decoding and encoding for <see cref="Unsigned16"/> values.
/// </summary>
public sealed class Unsigned16Codec :
    IAsduElementCodec<ushort>,
    IAsduPrimitiveCodec<ushort>
{
    /// <summary>
    /// Decodes a <see cref="ushort"/> value from the current reader position using the application tag.
    /// </summary>
    /// <param name="reader">The reader positioned at a <see cref="ushort"/> primitive tag.</param>
    ...
    /// </summary>
    /// <param name="source">The source payload bytes for the <see cref="ushort"/> value.</param>
    /// <returns>The decoded <see cref="ushort"/> value.</returns>
    ...
    {
        return checked((ushort)AsduPrimitives.ReadUnsigned16(source));
    }

    /// <summary>
    /// Encodes a <see cref="ushort"/> value using the application tag.
    /// </summary>
    ...
    public static void EncodeValue(Span<byte> destination, in ushort value)
    {
            AsduPrimitives.WriteUnsigned16(destination, checked((ushort)value));
    }

    /// <summary>
    /// Gets the encoded payload length for a <see cref="Unsigned16"/> value.
    /// </summary>
    /// <param name="value">The value whose payload length is requested.</param>
    /// <returns>The encoded payload length in bytes.</returns>
    public static int GetEncodedValueLength(in ushort value)
