    ...
    IAsduPrimitiveCodec<T.AccessZoneOccupancyState>
{
    ...
    public static T.AccessZoneOccupancyState Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<AccessZoneOccupancyStateCodec, T.AccessZoneOccupancyState>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.AccessZoneOccupancyState Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<AccessZoneOccupancyStateCodec, T.AccessZoneOccupancyState>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.AccessZoneOccupancyState value)
        => Asdu.EncodePrimitive<AccessZoneOccupancyStateCodec, T.AccessZoneOccupancyState>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.AccessZoneOccupancyState value)
        => Asdu.EncodePrimitive<AccessZoneOccupancyStateCodec, T.AccessZoneOccupancyState>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.AccessZoneOccupancyState value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.AccessZoneOccupancyState value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
