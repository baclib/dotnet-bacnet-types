    ...
    IAsduPrimitiveCodec<int>
{
    ...
    public static int Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<Integer32Codec, int>(ref reader);
    ...
    public static int Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<Integer32Codec, int>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in int value)
        => Asdu.EncodePrimitive<Integer32Codec, int>(ref writer, value);
    ...
    public static void Encode(ref NativeWriter writer, byte tagNumber, in int value)
        => Asdu.EncodePrimitive<Integer32Codec, int>(ref writer, tagNumber, value);
