...
/// <summary>
/// Provides BACnet ASDU primitive decoding and encoding for <see cref="Integer32"/> values.
/// </summary>
    ...
    IAsduPrimitiveCodec<int>
{
    ...
    /// </summary>
    /// <param name="reader">The reader positioned at a <see cref="int"/> primitive tag.</param>
    ...
    /// </summary>
    /// <param name="source">The source payload bytes for the <see cref="int"/> value.</param>
    /// <returns>The decoded <see cref="int"/> value.</returns>
    ...
    {
        return checked((int)AsduPrimitives.ReadInteger32(source));
    ...
    {
            AsduPrimitives.WriteInteger32(destination, checked((int)value));
    }

    /// <summary>
    /// Gets the encoded payload length for a <see cref="Integer32"/> value.
    /// </summary>
