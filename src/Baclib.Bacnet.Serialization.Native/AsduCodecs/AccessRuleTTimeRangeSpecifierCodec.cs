    ...
    IAsduPrimitiveCodec<T.AccessRule.TTimeRangeSpecifier>
{
    ...
    public static T.AccessRule.TTimeRangeSpecifier Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<AccessRuleTTimeRangeSpecifierCodec, T.AccessRule.TTimeRangeSpecifier>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.AccessRule.TTimeRangeSpecifier Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<AccessRuleTTimeRangeSpecifierCodec, T.AccessRule.TTimeRangeSpecifier>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.AccessRule.TTimeRangeSpecifier value)
        => Asdu.EncodePrimitive<AccessRuleTTimeRangeSpecifierCodec, T.AccessRule.TTimeRangeSpecifier>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.AccessRule.TTimeRangeSpecifier value)
        => Asdu.EncodePrimitive<AccessRuleTTimeRangeSpecifierCodec, T.AccessRule.TTimeRangeSpecifier>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.AccessRule.TTimeRangeSpecifier value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.AccessRule.TTimeRangeSpecifier value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
