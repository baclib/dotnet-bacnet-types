    ...
    IAsduPrimitiveCodec<T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter>
{
    ...
    public static T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<GetEnrollmentSummaryRequestTAcknowledgmentFilterCodec, T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<GetEnrollmentSummaryRequestTAcknowledgmentFilterCodec, T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter value)
        => Asdu.EncodePrimitive<GetEnrollmentSummaryRequestTAcknowledgmentFilterCodec, T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter value)
        => Asdu.EncodePrimitive<GetEnrollmentSummaryRequestTAcknowledgmentFilterCodec, T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.GetEnrollmentSummaryRequest.TAcknowledgmentFilter value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
