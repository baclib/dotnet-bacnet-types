...
public sealed class ReadPropertyRequestCodec :
    IAsduElementCodec<global::Baclib.Bacnet.Types.Application.ReadPropertyRequest>,
    IAsduConstructedCodec<global::Baclib.Bacnet.Types.Application.ReadPropertyRequest>
{
    ...
    public static global::Baclib.Bacnet.Types.Application.ReadPropertyRequest Decode(ref NativeReader reader)
    {
        ...
        return new global::Baclib.Bacnet.Types.Application.ReadPropertyRequest
        {
    ...
    public static global::Baclib.Bacnet.Types.Application.ReadPropertyRequest Decode(ref NativeReader reader, byte tagNumber)
    {
    ...
    public static void Encode(ref NativeWriter writer, in global::Baclib.Bacnet.Types.Application.ReadPropertyRequest value)
    {
    ...
    public static void Encode(ref NativeWriter writer, byte tagNumber, in global::Baclib.Bacnet.Types.Application.ReadPropertyRequest value)
    {
    ...
    public static int GetLength(in global::Baclib.Bacnet.Types.Application.ReadPropertyRequest value)
    {
    ...
    public static int GetLength(in global::Baclib.Bacnet.Types.Application.ReadPropertyRequest value, byte tagNumber)
    {
