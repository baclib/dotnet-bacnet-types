    ...
    IAsduPrimitiveCodec<T.BitString64>
{
    ...
    public static T.BitString64 Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<BitString64Codec, T.BitString64>(ref reader);
    ...
    /// <returns>The decoded value.</returns>
    public static T.BitString64 Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<BitString64Codec, T.BitString64>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.BitString64 value)
        => Asdu.EncodePrimitive<BitString64Codec, T.BitString64>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.BitString64 value)
        => Asdu.EncodePrimitive<BitString64Codec, T.BitString64>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.BitString64 value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.BitString64 value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
