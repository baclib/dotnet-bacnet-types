    ...
    IAsduPrimitiveCodec<T.EventType>
{
    ...
    public static T.EventType Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<EventTypeCodec, T.EventType>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.EventType Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<EventTypeCodec, T.EventType>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.EventType value)
        => Asdu.EncodePrimitive<EventTypeCodec, T.EventType>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.EventType value)
        => Asdu.EncodePrimitive<EventTypeCodec, T.EventType>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.EventType value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.EventType value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
