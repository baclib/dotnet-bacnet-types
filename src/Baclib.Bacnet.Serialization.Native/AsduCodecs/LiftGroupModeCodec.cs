    ...
    IAsduPrimitiveCodec<T.LiftGroupMode>
{
    ...
    public static T.LiftGroupMode Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<LiftGroupModeCodec, T.LiftGroupMode>(ref reader);
    ...
    /// <returns>The decoded enumerated value.</returns>
    public static T.LiftGroupMode Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<LiftGroupModeCodec, T.LiftGroupMode>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.LiftGroupMode value)
        => Asdu.EncodePrimitive<LiftGroupModeCodec, T.LiftGroupMode>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.LiftGroupMode value)
        => Asdu.EncodePrimitive<LiftGroupModeCodec, T.LiftGroupMode>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.LiftGroupMode value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.LiftGroupMode value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
