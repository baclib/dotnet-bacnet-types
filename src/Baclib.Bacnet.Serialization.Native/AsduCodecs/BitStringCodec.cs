    ...
    IAsduPrimitiveCodec<T.BitString>
{
    ...
    public static T.BitString Decode(ref NativeReader reader)
        => Asdu.DecodePrimitive<BitStringCodec, T.BitString>(ref reader);
    ...
    /// <returns>The decoded value.</returns>
    public static T.BitString Decode(ref NativeReader reader, byte tagNumber)
        => Asdu.DecodePrimitive<BitStringCodec, T.BitString>(ref reader, tagNumber);
    ...
    public static void Encode(ref NativeWriter writer, in T.BitString value)
        => Asdu.EncodePrimitive<BitStringCodec, T.BitString>(ref writer, value);
    ...
    /// <param name="value">The value to encode.</param>
    public static void Encode(ref NativeWriter writer, byte tagNumber, in T.BitString value)
        => Asdu.EncodePrimitive<BitStringCodec, T.BitString>(ref writer, tagNumber, value);
    ...
    public static int GetLength(in T.BitString value)
    ...
    /// <param name="tagNumber">The context tag number.</param>
    /// <returns>The total encoded length in bytes.</returns>
    public static int GetLength(in T.BitString value, byte tagNumber)
        => AsduLength.Sum(tagNumber, GetEncodedValueLength(value));
