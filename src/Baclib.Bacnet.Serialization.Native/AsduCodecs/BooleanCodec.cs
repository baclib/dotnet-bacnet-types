...
/// <summary>
/// Provides BACnet ASDU primitive decoding and encoding for <see cref="Boolean"/> values.
/// </summary>
    ...
    IAsduPrimitiveCodec<bool>
{
    ...
    /// </summary>
    /// <param name="reader">The reader positioned at a <see cref="bool"/> primitive tag.</param>
    ...
    /// </summary>
    /// <param name="source">The source payload bytes for the <see cref="bool"/> value.</param>
    /// <returns>The decoded <see cref="bool"/> value.</returns>
    ...
    public static void Encode(ref AsduWriter writer, in bool value)
        => AsduPrimitive.Encode<BooleanCodec, bool>(ref writer, value);
    ...
    /// <summary>
    /// Gets the encoded payload length for a <see cref="Boolean"/> value.
    /// </summary>
