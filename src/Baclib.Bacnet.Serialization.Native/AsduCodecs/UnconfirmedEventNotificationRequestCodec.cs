...
public sealed class UnconfirmedEventNotificationRequestCodec :
    IAsduElementCodec<T::UnconfirmedEventNotificationRequest>,
    IAsduConstructedCodec<T::UnconfirmedEventNotificationRequest>
{
    public static T::UnconfirmedEventNotificationRequest Decode(ref AsduReader reader)
    {
        return new T::UnconfirmedEventNotificationRequest
        {
    ...
    public static T::UnconfirmedEventNotificationRequest Decode(ref AsduReader reader, byte tagNumber)
        => AsduConstructed.Decode<UnconfirmedEventNotificationRequestCodec, T::UnconfirmedEventNotificationRequest>(ref reader, tagNumber);

    public static void Encode(ref AsduWriter writer, in T::UnconfirmedEventNotificationRequest value)
    {
    ...
    public static void Encode(ref AsduWriter writer, byte tagNumber, in T::UnconfirmedEventNotificationRequest value)
        => AsduConstructed.Encode<UnconfirmedEventNotificationRequestCodec, T::UnconfirmedEventNotificationRequest>(ref writer, tagNumber, value);

    public static int GetEncodedLength(in T::UnconfirmedEventNotificationRequest value)
    {
        var length = 0;
    ...
    public static int GetEncodedLength(in T::UnconfirmedEventNotificationRequest value, byte tagNumber)
        => AsduConstructed.GetEncodedLength<UnconfirmedEventNotificationRequestCodec, T::UnconfirmedEventNotificationRequest>(tagNumber, value);
