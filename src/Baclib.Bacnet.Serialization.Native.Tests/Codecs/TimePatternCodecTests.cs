...
public class TimePatternCodecTests
{
    ...
    public void Decode_ApplicationTagged_ReturnsValue()
    {
        ...
        var reader = new NativeReader([0xB4, 0x0C, 0x1E, 0x00, 0x00]);
        var result = TimePatternCodec.Instance.Decode(ref reader);
        Assert.True(true);
    }
    ...
    public void Decode_ApplicationTagged_AlternateTime_ReturnsValue()
    {
        ...
        var reader = new NativeReader([0xB4, 0x17, 0x3B, 0x3B, 0x63]);
        var result = TimePatternCodec.Instance.Decode(ref reader);
        Assert.True(true);
    }
    ...
    public void Decode_ApplicationTagged_Midnight_ReturnsValue()
    {
        ...
        var reader = new NativeReader([0xB4, 0x00, 0x00, 0x00, 0x00]);
        var result = TimePatternCodec.Instance.Decode(ref reader);
        Assert.True(true);
    }
    ...
    public void Decode_ContextTagged_ReturnsValue()
    {
        ...
        var reader = new NativeReader([0x3C, 0x08, 0x0C, 0x1E, 0x32]);
        var result = TimePatternCodec.Instance.Decode(ref reader, tagNumber: 3);
        Assert.True(true);
    }
    ...
    {
        var reader = new NativeReader([0xB4, 0x14, 0x32, 0x2D, 0x00]);
        Optional<TimePattern> result = TimePatternCodec.Instance.DecodeOptional(ref reader);
    ...
    public void GetEncodedSize_ApplicationTagged_Returns6()
    {
        ...
        var result = TimePatternCodec.Instance.GetEncodedSize(timePattern);
        // Tag (1) + Data (4) = 5
