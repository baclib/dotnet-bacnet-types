...
public class BitString64CodecTests
{
    ...
    public void Decode_ApplicationTagged_EmptyBitString_ReturnsEmpty()
    {
        ...
        var reader = new AsduReader([0x85, 0x09, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
        var result = BitString64Codec.Decode(ref reader);
    ...
    public void Decode_ApplicationTagged_SingleBit_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x85, 0x09, 0x3F, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
        var result = BitString64Codec.Decode(ref reader);
    ...
    public void Decode_ApplicationTagged_AllBits_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x85, 0x09, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]);
        var result = BitString64Codec.Decode(ref reader);
    ...
    {
        var reader = new AsduReader([0x85, 0x09, 0x10, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
        Optional<BitString64> result = Asdu.DecodeOptional<BitString64Codec, BitString64>(ref reader);
    ...
    public void Decode_ContextTagged_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x5D, 0x09, 0x00, 0x0F, 0x7B, 0x3D, 0x59, 0x1E, 0x6A, 0x2C, 0x48]);
        var result = BitString64Codec.Decode(ref reader, tagNumber: 5);
        Assert.Equal(64, result.Length);
    ...
    public void DecodeOptional_ContextTagged_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x3D, 0x09, 0x30, 0x0F, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
        Optional<BitString64> result = Asdu.DecodeOptional<BitString64Codec, BitString64>(ref reader, tagNumber: 3);
        Assert.True(result.HasValue);
    ...
    public void GetEncodedSize_ApplicationTagged_ReturnsExpected()
    {
        ...
        var result = BitString64Codec.GetEncodedLength(bitString);
