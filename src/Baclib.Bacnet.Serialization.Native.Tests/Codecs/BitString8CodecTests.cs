...
public class BitString8CodecTests
{
    ...
    public void Decode_ApplicationTagged_EmptyBitString_ReturnsEmpty()
    {
        ...
        var reader = new AsduReader([0x82, 0x08, 0x00]);
        var result = BitString8Codec.Decode(ref reader);
    ...
    public void Decode_ApplicationTagged_SingleBit_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x82, 0x07, 0x80]);
        var result = BitString8Codec.Decode(ref reader);
    ...
    public void Decode_ApplicationTagged_AllBits_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x82, 0x00, 0xFF]);
        var result = BitString8Codec.Decode(ref reader);
    ...
    public void Decode_ApplicationTagged_MixedBits_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x82, 0x04, 0xA0]);
        var result = BitString8Codec.Decode(ref reader);
    ...
    public void Decode_ContextTagged_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x2A, 0x00, 0x55]);
        var result = BitString8Codec.Decode(ref reader, tagNumber: 2);
        Assert.Equal(8, result.Length);
    ...
    {
        var reader = new AsduReader([0x82, 0x06, 0xC0]);
        Optional<BitString8> result = Asdu.DecodeOptional<BitString8Codec, BitString8>(ref reader);
    ...
    public void DecodeOptional_ContextTagged_ReturnsValue()
    {
        ...
        var reader = new AsduReader([0x0A, 0x02, 0x40]);
        Optional<BitString8> result = Asdu.DecodeOptional<BitString8Codec, BitString8>(ref reader, tagNumber: 0);
        Assert.True(result.HasValue);
    ...
    public void GetEncodedSize_ApplicationTagged_ReturnsExpected()
    {
        ...
        var result = BitString8Codec.GetEncodedLength(bitString);
    ...
    public void GetEncodedSize_ContextTagged_ReturnsExpected()
    {
        ...
        var result = BitString8Codec.GetEncodedLength(bitString, tagNumber: 0);
        // Tag (1) + Data (1: unused bits) + Data (1: actual bits) = 3
        Assert.Equal(3, result);
    }
}
