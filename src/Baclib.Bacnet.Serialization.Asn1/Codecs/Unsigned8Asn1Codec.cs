...
public sealed class Unsigned8Asn1Codec : Asn1CodecBase<byte>
{
    ...
    {
        var bytes = encoder.Encode(tagNumber, tagClass, AsduLength.Unsigned8);
        AsduPrimitives.WriteUnsigned8(bytes, value);
    }
