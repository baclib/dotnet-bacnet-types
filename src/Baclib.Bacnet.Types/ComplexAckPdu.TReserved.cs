...
{
    /// <summary>
    /// Represents the BACnet primitive data type reserved with a range restriction from 0 to 3.
    /// </summary>
    public readonly record struct TReserved : IComparable<TReserved>, IComparable
    {
        ...
        /// </summary>
        /// <param name="value">The instance value, must be in the range from 0 to 3.</param>
        /// <exception cref="ArgumentOutOfRangeException">
        /// Thrown when <paramref name="value"/> is less than <see cref="MinValue"/> (0) 
        /// or greater than <see cref="MaxValue"/> (3).
        /// </exception>
