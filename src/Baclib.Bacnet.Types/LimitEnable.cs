...
public readonly record struct LimitEnable : IReadOnlyCollection<bool>
{
    ...
    {
        /// <summary>
        /// Copy of the parent <see cref="LimitEnable"/> instance being enumerated.
        /// </summary>
        ...
        /// Valid indices are 0..(<see cref="LimitEnable.FixCount"/> - 1).
        /// </summary>
        private int _index;
        ...
        /// </summary>
        /// <param name="bits">The parent <see cref="LimitEnable"/> instance to enumerate.</param>
        /// <remarks>
