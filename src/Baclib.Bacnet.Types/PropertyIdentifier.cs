...
/// <summary>
/// Represents the enumeration BACnetPropertyIdentifier as defined in ANSI/ASHRAE 135-2024 Clause 21.
/// </summary>
public enum PropertyIdentifier : uint
{
    /// <summary>
    /// BACnetEventTransitionBits indicating acknowledged transitions (0)
    /// </summary>
    AckedTransitions = 0,

    /// <summary>
    /// BACnetEventTransitionBits indicating which transitions require acknowledgement (1)
    /// </summary>
    AckRequired = 1,
    ...
    /// <summary>
    /// Text description of action (3)
    /// </summary>
    ActionText = 3,

    /// <summary>
    /// Text displayed when binary value is active (4)
    /// </summary>
    ActiveText = 4,

    /// <summary>
    /// List of active virtual terminal sessions (5)
    /// </summary>
    ActiveVtSessions = 5,

    /// <summary>
    /// Alarm value for analog inputs (6)
    /// </summary>
    AlarmValue = 6,

    /// <summary>
    /// List of alarm values (7)
    /// </summary>
    AlarmValues = 7,

    /// <summary>
    /// Indicates all properties (8)
    /// </summary>
    All = 8,

    /// <summary>
    /// Indicates if all writes were successful (9)
    /// </summary>
    AllWritesSuccessful = 9,

    /// <summary>
    /// Timeout for APDU segment transmission (10)
    /// </summary>
    ApduSegmentTimeout = 10,

    /// <summary>
    /// Timeout for APDU response (11)
    /// </summary>
    ApduTimeout = 11,

    /// <summary>
    /// Version of application software (12)
    /// </summary>
    ...
    /// <summary>
    /// Number of change of state occurrences (15)
    /// </summary>
    ChangeOfStateCount = 15,

    /// <summary>
    /// Time of last change of state (16)
    /// </summary>
    ChangeOfStateTime = 16,

    /// <summary>
    /// Notification class for event reporting (17)
    /// </summary>
    NotificationClass = 17,

    /// <summary>
    /// Reference to controlled variable (19)
    /// </summary>
    ControlledVariableReference = 19,

    /// <summary>
    /// Engineering units of controlled variable (20)
    /// </summary>
    ControlledVariableUnits = 20,

    /// <summary>
    /// Current value of controlled variable (21)
    /// </summary>
    ControlledVariableValue = 21,

    /// <summary>
    /// Change of value increment (22)
    /// </summary>
    CovIncrement = 22,
    ...
    /// <summary>
    /// Indicates daylight savings time status (24)
    /// </summary>
    ...
    /// <summary>
    /// Derivative constant for PID control (26)
    /// </summary>
    DerivativeConstant = 26,

    /// <summary>
    /// Engineering units for derivative constant (27)
    /// </summary>
    DerivativeConstantUnits = 27,

    /// <summary>
    /// Textual description (28)
    /// </summary>
    Description = 28,

    /// <summary>
    /// Description of halt condition (29)
    /// </summary>
    DescriptionOfHalt = 29,

    /// <summary>
    /// Device address binding table (30)
    /// </summary>
    ...
    /// <summary>
    /// Effective period for schedule (32)
    /// </summary>
    EffectivePeriod = 32,

    /// <summary>
    /// Accumulated active time (33)
    /// </summary>
    ElapsedActiveTime = 33,

    /// <summary>
    /// Error limit threshold (34)
    /// </summary>
    ErrorLimit = 34,

    /// <summary>
    /// Event notification enable flags (35)
    /// </summary>
    EventEnable = 35,

    /// <summary>
    /// Current event state (36)
    /// </summary>
    EventState = 36,
    ...
    /// <summary>
    /// Exception schedule entries (38)
    /// </summary>
    ExceptionSchedule = 38,

    /// <summary>
    /// Fault condition values (39)
    /// </summary>
    FaultValues = 39,

    /// <summary>
    /// Feedback value in control loop (40)
    /// </summary>
    FeedbackValue = 40,
    ...
    /// <summary>
    /// Firmware revision string (44)
    /// </summary>
    FirmwareRevision = 44,

    /// <summary>
    /// High limit for analog value (45)
    /// </summary>
    HighLimit = 45,

    /// <summary>
    /// Text displayed when binary value is inactive (46)
    /// </summary>
    InactiveText = 46,

    /// <summary>
    /// Indicates command in process (47)
    /// </summary>
    InProcess = 47,

    /// <summary>
    /// Object identifier of which this is an instance (48)
    /// </summary>
    InstanceOf = 48,

    /// <summary>
    /// Integral constant for PID control (49)
    /// </summary>
    IntegralConstant = 49,

    /// <summary>
    /// Engineering units for integral constant (50)
    /// </summary>
    IntegralConstantUnits = 50,

    /// <summary>
    /// Indicates if confirmed notifications are issued (51)
    /// </summary>
    IssueConfirmedNotifications = 51,

    /// <summary>
    /// Limit enable flags (52)
    /// </summary>
    LimitEnable = 52,

    /// <summary>
    /// List of group member references (53)
    /// </summary>
    ...
    /// <summary>
    /// Physical location description (58)
    /// </summary>
    Location = 58,

    /// <summary>
    /// Low limit for analog value (59)
    /// </summary>
    LowLimit = 59,

    /// <summary>
    /// Reference to manipulated variable (60)
    /// </summary>
    ManipulatedVariableReference = 60,

    /// <summary>
    /// Maximum output value (61)
    /// </summary>
    MaximumOutput = 61,

    /// <summary>
    /// Maximum APDU length accepted (62)
    /// </summary>
    MaxApduLengthAccepted = 62,

    /// <summary>
    /// Maximum information frames (63)
    /// </summary>
    MaxInfoFrames = 63,

    /// <summary>
    /// Maximum master address (64)
    /// </summary>
    MaxManager = 64,

    /// <summary>
    /// Maximum present value (65)
    /// </summary>
    MaxPresValue = 65,
    ...
    /// <summary>
    /// Minimum output value (68)
    /// </summary>
    MinimumOutput = 68,

    /// <summary>
    /// Minimum present value (69)
    /// </summary>
    MinPresValue = 69,

    /// <summary>
    /// Model name of device (70)
    /// </summary>
    ModelName = 70,

    /// <summary>
    /// Date of last modification (71)
    /// </summary>
    ModificationDate = 71,

    /// <summary>
    /// Type of notification (72)
    /// </summary>
    NotifyType = 72,
    ...
    /// <summary>
    /// Number of states for multistate value (74)
    /// </summary>
    NumberOfStates = 74,
    ...
    /// <summary>
    /// Optional property indicator (80)
    /// </summary>
    Optional = 80,

    /// <summary>
    /// Out of service indicator (81)
    /// </summary>
    OutOfService = 81,

    /// <summary>
    /// Output engineering units (82)
    /// </summary>
    OutputUnits = 82,

    /// <summary>
    /// Event algorithm parameters (83)
    /// </summary>
    EventParameters = 83,

    /// <summary>
    /// Polarity of binary input (84)
    /// </summary>
    Polarity = 84,

    /// <summary>
    /// Present value of object (85)
    /// </summary>
    PresentValue = 85,
    ...
    /// <summary>
    /// Program change indicator (90)
    /// </summary>
    ProgramChange = 90,

    /// <summary>
    /// Location of program (91)
    /// </summary>
    ProgramLocation = 91,

    /// <summary>
    /// State of program execution (92)
    /// </summary>
    ProgramState = 92,

    /// <summary>
    /// Proportional constant for PID control (93)
    /// </summary>
    ProportionalConstant = 93,

    /// <summary>
    /// Engineering units for proportional constant (94)
    /// </summary>
    ...
    /// <summary>
    /// Protocol version number (98)
    /// </summary>
    ProtocolVersion = 98,

    /// <summary>
    /// Read-only indicator (99)
    /// </summary>
    ReadOnly = 99,

    /// <summary>
    /// Reason for program halt (100)
    /// </summary>
    ReasonForHalt = 100,

    /// <summary>
    /// List of event notification recipients (102)
    /// </summary>
    RecipientList = 102,

    /// <summary>
    /// Reliability indicator (103)
    /// </summary>
    Reliability = 103,

    /// <summary>
    /// Default value when all priorities relinquished (104)
    /// </summary>
    RelinquishDefault = 104,

    /// <summary>
    /// Required property indicator (105)
    /// </summary>
    Required = 105,

    /// <summary>
    /// Resolution of value (106)
    /// </summary>
    Resolution = 106,

    /// <summary>
    /// Segmentation support level (107)
    /// </summary>
    ...
    /// <summary>
    /// Reference to setpoint (109)
    /// </summary>
    SetpointReference = 109,

    /// <summary>
    /// Text array for multistate values (110)
    /// </summary>
    StateText = 110,
    ...
    /// <summary>
    /// Time delay for event detection (113)
    /// </summary>
    TimeDelay = 113,
    ...
    /// <summary>
    /// List of time synchronization recipients (116)
    /// </summary>
    TimeSynchronizationRecipients = 116,

    /// <summary>
    /// Engineering units (117)
    /// </summary>
    Units = 117,
    ...
    /// <summary>
    /// Virtual terminal classes supported (122)
    /// </summary>
    ...
    /// <summary>
    /// Number of attempted samples (124)
    /// </summary>
    ...
    /// <summary>
    /// Log device object property reference (132)
    /// </summary>
    ...
    /// <summary>
    /// Auto subordinate discovery flag (169)
    /// </summary>
    AutoSubordinateDiscovery = 169,

    /// <summary>
    /// Manual subordinate address binding (170)
    /// </summary>
    ManualSubordinateAddressBinding = 170,

    /// <summary>
    /// Subordinate address binding (171)
    /// </summary>
    SubordinateAddressBinding = 171,

    /// <summary>
    /// Subordinate proxy enable flag (172)
    /// </summary>
    ...
    /// <summary>
    /// Event algorithm inhibit reference (355)
    /// </summary>
    ...
    /// <summary>
    /// Maximum actual value (382)
    /// </summary>
    MaxActualValue = 382,

    /// <summary>
    /// Minimum actual value (383)
    /// </summary>
    MinActualValue = 383,
    ...
    /// <summary>
    /// Maximum BVLC length accepted (4194304)
    /// </summary>
    MaxBvlcLengthAccepted = 4194304,

    /// <summary>
    /// Maximum NPDU length accepted (4194305)
    /// </summary>
    ...
    /// <summary>
    /// Maximum proxied I-Ams per second (4194349)
    /// </summary>
