...
/// <summary>
/// Represents the bit string BACnetServicesSupported as defined in ANSI/ASHRAE 135-2024 Clause 21.
/// </summary>
public readonly record struct ServicesSupported
{
    /// <summary>
    ...
    /// <summary>
    /// The minimum allowed length for an instance of <see cref="ServicesSupported"/>.
    /// </summary>
    public const int MinLength = 35;

    /// <summary>
    /// The maximum allowed length for an instance of <see cref="ServicesSupported"/>.
    /// </summary>
