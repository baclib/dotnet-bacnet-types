...
/// <summary>
/// Represents the bit string BACnetAuditOperationFlags as defined in ANSI/ASHRAE 135-2024 Clause 21.
/// </summary>
public readonly record struct AuditOperationFlags
{
    /// <summary>
    ...
    /// <summary>
    /// The minimum allowed length for an instance of <see cref="AuditOperationFlags"/>.
    /// </summary>
    public const int MinLength = 16;

    /// <summary>
    /// The maximum allowed length for an instance of <see cref="AuditOperationFlags"/>.
    /// </summary>
