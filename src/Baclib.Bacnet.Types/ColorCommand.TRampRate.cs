...
{
    /// <summary>
    /// Represents the BACnet primitive data type ramp-rate with a range restriction from 1 to 30000.
    /// </summary>
    public readonly record struct TRampRate : IComparable<TRampRate>, IComparable
    {
        ...
        /// <summary>
        /// Implicitly converts a <see cref="TRampRate"/> instance to a <see cref="ushort"/>.
        /// </summary>
        /// <param name="instance">The instance to convert.</param>
        public static implicit operator ushort(TRampRate instance) => instance.Value;
    
        /// <summary>
        /// Explicitly converts a <see cref="ushort"/> to a <see cref="TRampRate"/>.
        /// </summary>
        ...
        /// or greater than <see cref="MaxValue"/> (30000).
        /// </exception>
        public static explicit operator TRampRate(ushort value) => new(value);
