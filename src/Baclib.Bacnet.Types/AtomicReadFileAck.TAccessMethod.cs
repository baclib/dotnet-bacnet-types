...
public partial record class AtomicReadFileAck
{
    ...
    public partial record class TAccessMethod
    {
        ...
        {
            /// <summary>
            /// Data read from the file as a stream of bytes.
            /// </summary>
            StreamAccess,
    
            /// <summary>
            /// Data read from the file as a series of records.
            /// </summary>
            RecordAccess
        }
        ...
        /// <summary>
        /// Create function for Data read from the file as a stream of bytes.
        /// </summary>
        ...
        /// <summary>
        /// Create function for Data read from the file as a series of records.
        /// </summary>
