...
/// <summary>
/// Represents the bit string BACnetLogStatus as defined in ANSI/ASHRAE 135-2024 Clause 20.6.
/// </summary>
public readonly record struct LogStatus : IReadOnlyCollection<bool>
{
    ...
    {
        /// <summary>
        /// Copy of the parent <see cref="LogStatus"/> instance being enumerated.
        /// </summary>
        ...
        /// Valid indices are 0..(<see cref="LogStatus.FixCount"/> - 1).
        /// </summary>
        private int _index;
        ...
        /// </summary>
        /// <param name="bits">The parent <see cref="LogStatus"/> instance to enumerate.</param>
        /// <remarks>
