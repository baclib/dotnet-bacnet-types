...
/// <summary>
/// Represents the bit string BACnetObjectTypesSupported as defined in ANSI/ASHRAE 135-2024 Clause 21.
/// </summary>
public readonly record struct ObjectTypesSupported
{
    /// <summary>
    ...
    /// <summary>
    /// The minimum allowed length for an instance of <see cref="ObjectTypesSupported"/>.
    /// </summary>
    public const int MinLength = 18;

    /// <summary>
    /// The maximum allowed length for an instance of <see cref="ObjectTypesSupported"/>.
    /// </summary>
