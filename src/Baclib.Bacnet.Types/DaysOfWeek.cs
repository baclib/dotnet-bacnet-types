...
public readonly record struct DaysOfWeek : IReadOnlyCollection<bool>
{
    ...
    {
        /// <summary>
        /// Copy of the parent <see cref="DaysOfWeek"/> instance being enumerated.
        /// </summary>
        ...
        /// Valid indices are 0..(<see cref="DaysOfWeek.FixCount"/> - 1).
        /// </summary>
        private int _index;
        ...
        /// </summary>
        /// <param name="bits">The parent <see cref="DaysOfWeek"/> instance to enumerate.</param>
        /// <remarks>
        /// The constructor sets the internal index to -1 so enumeration starts before the first element.
        /// </remarks>
        internal Enumerator(DaysOfWeek bits)
        {
            _bits = bits;
            _index = -1;
        }
