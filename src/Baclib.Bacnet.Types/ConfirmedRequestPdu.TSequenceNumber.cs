...
{
    /// <summary>
    /// Represents the BACnet primitive data type sequence-number with a range restriction from 0 to 255.
    /// </summary>
    public readonly record struct TSequenceNumber : IComparable<TSequenceNumber>, IComparable
    {
        ...
        /// </exception>
        public TSequenceNumber(byte value)
        {
        ...
        /// <summary>
        /// Implicitly converts a <see cref="TSequenceNumber"/> instance to a <see cref="byte"/>.
        /// </summary>
        /// <param name="instance">The instance to convert.</param>
        public static implicit operator byte(TSequenceNumber instance) => instance.Value;
    
        /// <summary>
        /// Explicitly converts a <see cref="byte"/> to a <see cref="TSequenceNumber"/>.
        /// </summary>
        ...
        /// or greater than <see cref="MaxValue"/> (255).
        /// </exception>
        public static explicit operator TSequenceNumber(byte value) => new(value);
