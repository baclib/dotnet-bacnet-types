...
public readonly record struct EventTransitionBits : IReadOnlyCollection<bool>
{
    ...
    {
        /// <summary>
        /// Copy of the parent <see cref="EventTransitionBits"/> instance being enumerated.
        /// </summary>
        ...
        /// Valid indices are 0..(<see cref="EventTransitionBits.FixCount"/> - 1).
        /// </summary>
        private int _index;
        ...
        /// </summary>
        /// <param name="bits">The parent <see cref="EventTransitionBits"/> instance to enumerate.</param>
        /// <remarks>
