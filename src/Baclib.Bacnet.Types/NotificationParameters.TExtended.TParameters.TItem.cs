    ...
    public partial record class TExtended
    {
        public partial record class TParameters
        {
            ...
            public partial record class TItem
            {
                ...
                /// <summary>
                /// Create function for A device object property value parameter.
                /// </summary>
                public static TItem FromPropertyValue(DeviceObjectPropertyValue value)
                {
                    return new TItem(Option.PropertyValue, value);
                }
            }
        }
    }
