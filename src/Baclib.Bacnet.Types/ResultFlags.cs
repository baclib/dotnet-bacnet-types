...
public readonly record struct ResultFlags : IReadOnlyCollection<bool>
{
    ...
    /// </summary>
    /// <remarks>
    /// The enumerator is a struct so direct iteration over a <see cref="ResultFlags"/> value does not allocate.
    ...
    {
        /// <summary>
        /// Copy of the parent <see cref="ResultFlags"/> instance being enumerated.
        /// </summary>
        ...
        /// Valid indices are 0..(<see cref="ResultFlags.FixCount"/> - 1).
        /// </summary>
        private int _index;
        ...
        /// </summary>
        /// <param name="bits">The parent <see cref="ResultFlags"/> instance to enumerate.</param>
        /// <remarks>
        /// The constructor sets the internal index to -1 so enumeration starts before the first element.
        /// </remarks>
        internal Enumerator(ResultFlags bits)
        {
            _bits = bits;
            _index = -1;
        }
