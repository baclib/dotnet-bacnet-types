...
/// <summary>
/// Represents BACnet bit string BACnetResultFlags.
/// </summary>
public readonly partial record struct ResultFlags : IBitString
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ResultFlags"/> with a fixed bit length.
    /// </summary>
