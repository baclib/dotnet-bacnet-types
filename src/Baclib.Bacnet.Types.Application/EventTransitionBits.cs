...
/// <summary>
/// Represents BACnet bit string BACnetEventTransitionBits.
/// </summary>
public readonly partial record struct EventTransitionBits : IBitString
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="EventTransitionBits"/> with a fixed bit length.
    /// </summary>
