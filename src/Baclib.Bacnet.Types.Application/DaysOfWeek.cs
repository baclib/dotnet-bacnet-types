...
/// <summary>
/// Represents BACnet bit string BACnetDaysOfWeek.
/// </summary>
public readonly partial record struct DaysOfWeek : IBitString
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="DaysOfWeek"/> with a fixed bit length.
    /// </summary>
