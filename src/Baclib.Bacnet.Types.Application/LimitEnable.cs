...
/// <summary>
/// Represents BACnet bit string BACnetLimitEnable.
/// </summary>
public readonly partial record struct LimitEnable : IBitString
{
    /// <summary>
    /// Fixed number of bits for this type.
    /// </summary>
    public const int FixedLength = 2;
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="LimitEnable"/> with a fixed bit length.
    /// </summary>
