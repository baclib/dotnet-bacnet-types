    ...
    public partial record class TExtended
    {
        ...
        public partial record class TParametersItem
        {
            ...
            public enum Option : byte
            {
                ...
                /// <summary>
                /// A device object property value parameter.
                /// </summary>
                PropertyValue
            }
            ...
            /// </summary>
            public static TParametersItem FromDate(Date value)
            {
            ...
            /// </summary>
            public static TParametersItem FromTime(Time value)
            {
            ...
            /// A device object property value parameter.
            /// </summary>
            public DeviceObjectPropertyValue PropertyValue
            {
                get
                {
                    ...
                    return (DeviceObjectPropertyValue)_choiceValue;
                }
            }
            ...
            /// </summary>
            public bool TryGetPropertyValue(out DeviceObjectPropertyValue value)
            {
                if (Choice == Option.PropertyValue)
                {
                    value = (DeviceObjectPropertyValue)_choiceValue;
                    return true;
                }
            ...
            /// </summary>
            public static TParametersItem FromPropertyValue(DeviceObjectPropertyValue value)
            {
                return new TParametersItem(Option.PropertyValue, value);
            }
        }
    }
}
